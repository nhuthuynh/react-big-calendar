  ...
  (function(_Component) {
    ...
    _proto.render = function render() {
      var _this$props = this.props,
        ...
        getters = _this$props.getters,
        businessHours = _this$props.businessHours,
        _this$props$component = _this$props.components
  ...
  (function(_React$Component) {
    ...
    function DayColumn() {
      ...
      _this._selectable = function() {
        ...
        var maybeSelect = function maybeSelect(box) {
          var _this$props2 = _this.props,
            onSelecting = _this$props2.onSelecting,
            disable = _this$props2.disable,
            businessHours = _this$props2.businessHours
          var current = _this.state || {}
          var state = selectionState(box)
          var start = state.startDate,
            end = state.endDate // return if the date is in disable days

          if (disable) return // Return if there are business hours and the start date is not included
    ...
    _proto.render = function render() {
      var _this$props4 = this.props,
        ...
        getters = _objectWithoutPropertiesLoose(_this$props4$getters, [
          'dayProp',
        ]),
        _this$props4$componen = _this$props4.components,
        EventContainer = _this$props4$componen.eventContainerWrapper,
        components = _objectWithoutPropertiesLoose(_this$props4$componen, [
          'eventContainerWrapper',
        ]),
        disable = _this$props4.disable,
        businessHours = _this$props4.businessHours
    ...
    _proto.renderEvents = function renderEvents(
      ...
      return resources.map(function(_ref, i) {
        ...
        return range.map(function(date, jj) {
          ...
          var disables =
            disabledDays &&
            disabledDays.filter(function(disabledDate) {
              return dates.diff(disabledDate, date, 'day') === 0
            })
          return React.createElement(
            DayColumn,
